var playSong = function(){
  ...
  $.getJSON('/getnextsong', function(song){
    ...
    if(song == "DONE"){
      ...
      $("#play").append("<object type='application/x-shockwave-flash' data='http://grooveshark.com/songWidget.swf' width='500' height='501'><param name='wmode' value='window' /><param name='allowScriptAccess' value='always' /><param name='flashvars' value='hostname=cowbell.grooveshark.com&songIDs=" + song.grooveshark_id + "&style=metal&p=1' /></object>");
      $("#play").children(":first-child").remove();
      $("#play").prepend("<img src='"+song.album_art+"450x450_75.jpg' width='300' >")
